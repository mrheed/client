            ...
            <div className={classes.actions}>
              ...
              <Grid container alignItems="center" justify="space-between">
                ...
                <Grid style={{display: "flex", alignItems: "center"}}>
                  {withActions && (
                    <>
                    <Tooltip onClick={handleOpenFullDialog} title="Add item">
                      <IconButton aria-label="Add item">
                        <AddIcon />
                      </IconButton>
                    </Tooltip>
                    <Tooltip onClick={onExport!} title="Export to Excel">
                ...
                <Dialog scroll="body" open={fullScreenDialogOpen} onClose={handleCloseFullDialog} TransitionComponent={Transition}>
